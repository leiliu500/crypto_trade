...
function projectOrder(value: KrakenPaperHistoricalOrder, nowMs: number): DashboardOrderCard[] {
  ...
  return [{
    ...
    configurationVersion: plan.configurationVersion ?? null,
    regime: plan.regime ?? null,
    edgeSource: plan.edgeSource ?? null,
    edgeEffectiveSampleCount: plan.edgeEffectiveSampleCount ?? null,
    researchOnly: plan.researchOnly === true,
    conservativeNetEdgeBps: plan.conservativeNetEdgeBps ?? null,
