# Parallel spot strategy experiments — 10 September 2026
...
|---|---:|---:|---:|---:|
| Statistical trend / CUSUM | −$16.95 | −$6.46 | $37.51 | 1 (0/1) |
| OU mean reversion | −$186.39 | −$218.82 | $225.98 | 3 (3/0) |
| BTC/ETH momentum rotation | −$98.00 | −$159.49 | $395.40 | 4 (3/1) |
| Cash | $0.00 | $0.00 | $0.00 | 0 (0/0) |
| BTC buy-and-hold | −$143.82 | −$154.60 | $419.97 | 1 (0/1) |
| ETH buy-and-hold | −$223.00 | −$227.54 | $563.39 | 1 (0/1) |
...
Root independently recalculated those selections, evaluated only **July–December 2025**, and locked the family ranking before invoking the final evaluation. The selection lock timestamp is `2026-09-10T18:04:30.822912+00:00`.

| Frozen family candidate | Validation base net | Validation stress net | Closed episodes |
|---|---:|---:|---:|
| Statistical trend / CUSUM | +$118.27 | +$93.43 | 1 |
| OU mean reversion | −$216.70 | −$246.12 | 3 |
| BTC/ETH momentum rotation | +$461.59 | +$498.34 | 2 |
...
The fee-only diagnostic keeps signal and execution timing fixed. Even at **zero commissions**, while retaining 3-basis-point adverse execution, final results are negative: Statistical trend / CUSUM −$1.10; OU mean reversion −$141.53; BTC/ETH momentum rotation −$35.48. Fees worsen performance, but reducing them alone did not create a profitable edge in these candidates.
...
|---|---:|---:|
| Statistical trend / CUSUM | −$64.19 | −$101.73 |
| OU mean reversion | −$464.93 | −$703.49 |
| BTC/ETH momentum rotation | −$599.12 | −$821.11 |
